...
addEventHandler( "onClientResourceStart", resourceRoot,
	function()
        ...
        blurHShaderBloom,tecName = dxCreateShader( "blurH.fx" )
        blurVShaderBloom,tecName = dxCreateShader( "blurV.fx" )
        brightPassShaderBloom,tecName = dxCreateShader( "brightPass.fx" )
        addBlendShaderBloom,tecName = dxCreateShader( "addBlend.fx" )
