...
function RenderGauge()
	...
	dxDrawRectangle(sX1*1640, sY1*1022, sX1*2.31*(g_Nos), sY1*26, tocolor(30,30,220,190), true)
	dxDrawText("Nitro",sX1*1726, sY1*1022, sX1*50, sY1*30,tocolor(255,255,255,255),sX1*1.8,"default-bold","left","top",false,false,true,true)
end
