...
function onSomeoneLoggedIn()
  ...
  if isObjectInACLGroup("user."..accountName,aclGetGroup("Admin")) then
    unbindKey(source,"F10","down", toggleClientPanel)
    bindKey(source,"F10","down", toggleClientPanel)
  end
end
...
function startedResource()
    ...
    if isObjectInACLGroup("user."..accountName,aclGetGroup("Admin")) then
      if (isKeyBound (v,"F10") == false) then
        unbindKey(v,"F10","down", toggleClientPanel)
        bindKey(v,"F10","down", toggleClientPanel)
      end
		end
	end
end
